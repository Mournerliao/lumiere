...
- **Windows distribution lane — [Issue #12](https://github.com/sousouliao/lumiere/issues/12):**
  ...
  The SignPath Foundation application was submitted on 2026-09-05 using that release as prerequisite
  evidence. Next: await approval and the assigned certificate Subject. Production sparse
