...
public sealed class PrivacyValidationTests
{
    ...
    [Fact]
    public void DiagnosticContext_PreviewFailure_DoesNotAcceptPixelData()
    {
    ...
    [Fact]
    public void DiagnosticContext_TrayFailure_DoesNotAcceptPixelData()
    {
        var record = DiagnosticContext.TrayFailure(
            stage: "Initialization",
            userFacingState: "Tray icon could not be created",
            technicalDetail: "Shell_NotifyIcon failed");
    ...
    [Fact]
    public void DiagnosticContext_HotkeyFailure_DoesNotAcceptPixelData()
    {
        var record = DiagnosticContext.HotkeyFailure(
            stage: "Registration",
            userFacingState: "Global hotkey could not be registered",
            technicalDetail: "RegisterHotKey returned FALSE");
