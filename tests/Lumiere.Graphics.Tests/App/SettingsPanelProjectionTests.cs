...
public sealed class SettingsPanelProjectionTests
{
    ...
    public void Project_SnapshotValidationSummarySurfacesIncompleteTargetHdrColorSpace()
    {
        ...
        Assert.Contains("Target-aware HDR evidence is incomplete", projection.Validation.EvidenceSummary.GapDetail, StringComparison.OrdinalIgnoreCase);
        Assert.Contains("target-aware HDR evidence color space", projection.Validation.EvidenceSummary.GapDetail, StringComparison.OrdinalIgnoreCase);
    }
