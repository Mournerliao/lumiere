...
The MVP is not a certification of perfect HDR preservation. It is the first credible product release that keeps the HDR foundation intact while avoiding unsupported claims.
...
- Long-run 50+ or 100+ cycle resource trend evidence as a release blocker.
...
- "Compatible clipboard and file output for everyday use."
