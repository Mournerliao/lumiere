...
3. [Settings projection](../../src/Lumiere.App.Core/SettingsPanelProjection.cs) - export profile selection is editable only where the profile contract allows it.
...
- Run manual checks on the native export profile radio-button path, especially selected-disabled states for validation-scoped profiles.
