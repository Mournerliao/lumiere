    ...
    OverlayFidelityCue FidelityCue)
{
    ...
    public static OverlayState Initializing(
        string message,
        string technicalDetail = "",
        OverlayFidelityCue? fidelityCue = null) =>
        new(
            ...
            fidelityCue ?? OverlayFidelityCue.Unvalidated);

    public static OverlayState HdrReady(
        string message,
        string technicalDetail = "",
        OverlayFidelityCue? fidelityCue = null) =>
        new(
    ...
    public static OverlayState DegradedPreview(
        string message,
        string technicalDetail = "",
        OverlayFidelityCue? fidelityCue = null) =>
        new(
            ...
            technicalDetail,
            OverlayFailureAction.KeepOpenWithFailure,
            fidelityCue ?? OverlayFidelityCue.Converted);

    public static OverlayState UnsupportedCapture(
        string message,
        string technicalDetail = "",
        OverlayFidelityCue? fidelityCue = null) =>
        new(
    ...
    public static OverlayState Closing(
        string message = "Closing overlay",
        string technicalDetail = "",
        OverlayFidelityCue? fidelityCue = null) =>
        new(
    ...
    public static OverlayState InvalidCrop(
        string message = "Crop region too small. Try again.",
        string technicalDetail = "",
        OverlayFidelityCue? fidelityCue = null) =>
        new(
    ...
    public static OverlayState Disposed(
        string message = "Preview stopped",
        string technicalDetail = "",
        OverlayFidelityCue? fidelityCue = null) =>
        new(
