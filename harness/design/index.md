...
- Onboarding, gallery, and annotation-heavy overlays remain post-MVP unless reintroduced by a story. Output workflows that are required for Perfect HDR Fidelity Public Release belong to Epic 11+ and are public-release prerequisites, not optional polish.
